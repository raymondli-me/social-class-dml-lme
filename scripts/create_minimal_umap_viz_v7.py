#!/usr/bin/env python3
"""
Minimal UMAP visualization v7 - smooth transitions, adjustable essay opacity
"""
...
print("=== Creating Minimal UMAP Visualization v7 ===")
...
<html>
<head>
    <title>UMAP Visualization - Smooth Gallery</title>
...
# Save
output_file = OUTPUT_DIR / 'minimal_umap_viz_v7.html'
with open(output_file, 'w') as f:
    f.write(html_content)

print(f"\n✅ Smooth gallery visualization saved to: {output_file}")
print("\nFeatures:")
print("- Adjustable essay background opacity (0-50%)")
print("- Smooth camera transitions with easing")
print("- Adjustable transition speed (0.5-3 seconds)")
print("- Camera orbits around points at different angles")
print("- Smooth return to overview when exiting gallery")
