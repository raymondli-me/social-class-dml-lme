...
<body>
    ...
    <div id="controls">
        ...
        <div class="control-group">
            ...
            <input type="range" id="point-size" min="0.5" max="20" step="0.5" value="6" oninput="debouncedUpdatePointSize()">
        </div>
        <div class="control-group">
            <label>Opacity: <span id="opacity-val">0.8</span></label>
            <input type="range" id="point-opacity" min="0.1" max="1" step="0.1" value="0.8" oninput="debouncedUpdateOpacity()">
        </div>
        <div class="control-group">
            <label>Cloud Scale: <span id="scale-val">4</span>x</label>
            <input type="range" id="cloud-scale" min="0.5" max="10" step="0.5" value="4" oninput="debouncedUpdateCloudScale()">
        </div>
