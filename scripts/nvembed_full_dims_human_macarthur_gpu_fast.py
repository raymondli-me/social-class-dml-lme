...
GPU-ONLY FAST VERSION - Skips Random Forest
"""
...
print("GPU-ONLY FAST VERSION (NO RANDOM FOREST)")
print("="*80)
...
# Define models - NO RANDOM FOREST for speed
models = {
    'Linear': {
...
for model_name in models.keys():
    ...
    gpu_marker = " [GPU]" if model_name == 'XGBoost' else ""
...
# Save results
output_file = NVEMBED_DIR / 'nvembed_human_macarthur_fast_comparison.pkl'
...
if abs(avg_ai_imp) < 0.02 and abs(avg_sc_imp) < 0.02:
    ...
    print("- GPU acceleration helps with XGBoost speed")
