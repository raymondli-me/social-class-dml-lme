...
print("=== Creating Minimal UMAP Visualization v20 ===")
...
# Save
output_file = OUTPUT_DIR / 'minimal_umap_viz_v20.html'
with open(output_file, 'w') as f:
    f.write(html_content)

print(f"\n✅ Enhanced visualization v20 with PC list in DML table saved to: {output_file}")
print("\nChanges in v20 (based on v19):")
print("- Added PC list (PC0, PC2, PC5, PC13, PC46) to DML table")
print("- Shows which specific PCs constitute the 'Top 5 PCs Model'")
print("- Displayed in subtle, italicized text below SC R² row")
print("\nAll v19 features preserved including:")
