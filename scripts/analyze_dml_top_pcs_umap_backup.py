                ...
                tooltip.innerHTML = `
                    ...
                    <div class="tooltip-section">
                        ...
                        <div style="font-style: italic; color: #ccc;">
                            "${{d.essay.split(' ').slice(0, 100).join(' ')}}${{d.essay.split(' ').length > 100 ? '...' : ''}}"
                        </div>
                        <div class="clickable" style="color: #88f; font-size: 11px; margin-top: 5px;" onclick="showFullText()">
                            [Click here to show full text]
                        </div>
                    </div>
                    <div class="tooltip-section">
                        ${{pcInfo}}
