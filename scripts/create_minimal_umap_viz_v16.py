#!/usr/bin/env python3
"""
Minimal UMAP visualization v16 - v14 with resizable essay display
- Based on v14 with all original functionality
- Added draggable resize for essay display
- Added minimize button on essay display
- Font size applies to all text content
- Height constraints: 80px min, 80% viewport max
"""
...
print("=== Creating Minimal UMAP Visualization v16 ===")
    ...
    <div id="info">
        ...
        <div class="control-group">
            ...
            <div style="margin-top: 5px;">
                Low: P<input type="number" id="ai-low-pct-input" min="0" max="50" value="10" step="1" style="width: 40px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3); color: white; padding: 2px 4px;" onchange="updatePercentileFromInput('ai', 'low')">
                <input type="range" id="ai-low-pct" min="0" max="50" value="10" step="1" style="width: 60px;" onchange="updateFromPercentiles('ai')">
                <br>
                High: P<input type="number" id="ai-high-pct-input" min="50" max="100" value="90" step="1" style="width: 40px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3); color: white; padding: 2px 4px;" onchange="updatePercentileFromInput('ai', 'high')">
                <input type="range" id="ai-high-pct" min="50" max="100" value="90" step="1" style="width: 60px;" onchange="updateFromPercentiles('ai')">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div style="margin-top: 5px;">
                Low: P<input type="number" id="sc-low-pct-input" min="0" max="50" value="10" step="1" style="width: 40px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3); color: white; padding: 2px 4px;" onchange="updatePercentileFromInput('sc', 'low')">
                <input type="range" id="sc-low-pct" min="0" max="50" value="10" step="1" style="width: 60px;" onchange="updateFromPercentiles('sc')">
                <br>
                High: P<input type="number" id="sc-high-pct-input" min="50" max="100" value="90" step="1" style="width: 40px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3); color: white; padding: 2px 4px;" onchange="updatePercentileFromInput('sc', 'high')">
                <input type="range" id="sc-high-pct" min="50" max="100" value="90" step="1" style="width: 60px;" onchange="updateFromPercentiles('sc')">
            </div>
        </div>
...
# Save
output_file = OUTPUT_DIR / 'minimal_umap_viz_v16.html'
with open(output_file, 'w') as f:
    f.write(html_content)

print(f"\n✅ Enhanced visualization v16 with resizable essay display saved to: {output_file}")
